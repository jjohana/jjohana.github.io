...
The Course module covers every taxonomy subchapter in the app. It links only active verified questions and flags subchapters that currently have no verified QCM support.

| Section | Topics | Subtopics | Linked verified QCMs | Subtopics with no verified QCM support |
|---|---:|---:|---:|---:|
| Market Knowledge | 7 | 105 | 738 | 0 |
| U.S. Regulations | 4 | 57 | 375 | 0 |
| Total | 11 | 162 | 1113 | 0 |
