...
- Total active verified QCMs: 1113
- Market Knowledge active verified QCMs: 738
- U.S. Regulations active verified QCMs: 375
- Subtopics below 3 active verified QCMs: 0
- Subtopics with 0 active verified QCMs: 0

The totals were updated after the rejected-queue rewrite pass. No imported items remain in `needs_review` or `rejected`, and the authored minimum-coverage set still keeps every taxonomy subtopic at or above the 3-verified-QCM floor.
